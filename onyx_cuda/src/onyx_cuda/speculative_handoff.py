"""Framework-neutral handoff across exactly two speculative transactions."""
...
class SpeculativeHandoffError(BackendError):
    """Base error raised by the bounded two-iteration handoff."""


class SpeculativeHandoffInvariantError(SpeculativeHandoffError):
    """Raised when completed transaction evidence violates the D39 contract."""
